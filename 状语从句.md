 ...
 * @LastEditTime: 2020-04-17 10:19:11
...
+ 形容词和副词能充当的成分
  ...
  2. 副词
     ...
     > Actually,he cries. 修饰句子 => 修饰全句的副词一定是置于句首
---
## 状语
...
1. 引导词
   + when = while = as 
     - 当 **" while "** 翻译为 **“ 当...的时候 ”**，视为副词连词，引导状语从句；后面要跟进行时态
     > While I was writting a letter,she was doing the dishies.
   + before
   + after
   + since
...
+ 引导词：where = in the place where = in the place which
  > The kind of trees grow well in moist places.

  > The kind of trees grow well where it is moist.

  > The kind of trees grow well in the place where it is moist.
#### 原因状语从句
1. 引导词：**because**、**as**、since、**in that**、seeing that、considering that、now that  
   - **in that** 引导状语从句多位于主句之后，而because引导的状语从句可置于主句之前或之后。
   > He is great **in that** he speaks five different languages. 
   - **since** 表 “ 自从 ” 时，所引导的状语**从句**采**一般过去时**，**主句**则为**现在完成时**或**现在完成进行时**。
   > Since you have finished the work,you may leave anytime. 

   > He has been studying quit hard (ever)**since he went to college**.
2. 连词：for
...
+ 例句
  ...
  - 注意**避免双重连接**
    - because ... so ...(X)
    - though ... but ...(X) 
    > **Because** she is nice,**so** I like her very much.(X)

    > **Because** she is nice,I like her very much.(O)
     
    > She is very nice,**so** I like her very much.(O)
  - 状语从句可视为副词修饰句子 
    > He had a car accident **because he was careless**. => **Because** he was careless,he had a car.
  - 副词连词冠于任何一个从句前面，该从句就成为状语从句。
  - 任何一个副词连词所引导的从句若置于**主句之后**，两句之间通常**不加逗号**。但该状语从句若置于**主句之前**，则两句之间之间通常**加逗号**。
